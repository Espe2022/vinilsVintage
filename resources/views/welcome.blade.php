...
<section class="max-w-7xl mx-auto p-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
    ...
    <div class="bg-white rounded-2xl shadow hover:shadow-2xl transition transform hover:-translate-y-1 p-4">
        ...
        <p class="text-gray-600 text-center">The Beatles</p>
        <p class="text-green-600 font-bold mt-2 text-center">$39.99</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow hover:shadow-2xl transition transform hover:-translate-y-1 p-4">
        ...
        <p class="text-gray-600 text-center">Pink Floyd</p>
        <p class="text-green-600 font-bold mt-2 text-center">$42.50</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow hover:shadow-2xl transition transform hover:-translate-y-1 p-4">
        ...
        <p class="text-gray-600 text-center">Pablo Alborán</p>
        <p class="text-green-600 font-bold mt-2 text-center">$35.00</p>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow hover:shadow-2xl transition transform hover:-translate-y-1 p-4">
        ...
        <p class="text-gray-600 text-center">Manuel Carrasco</p>
        <p class="text-green-600 font-bold mt-2 text-center">$24.99</p>
    </div>
